...
func SetupRoutes(apiBasePath string) {
	handleReceipt := http.HandlerFunc(handleReceipts)
	handleDownload := http.HandlerFunc(handleReceipts)
	http.Handle(fmt.Sprintf("%s/%s", apiBasePath, receiptPath), cors.Middleware(handleReceipt))
